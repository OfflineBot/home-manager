{ config, pkgs, ... }:
{
    home.file.".config/zathura/zathurarc".text = ''
        ...
        set default-bg                  rgba(15,15,15,1)

        # main page color
        #set recolor-lightcolor          rgba(30,30,30,0.7)
        #set recolor-darkcolor           rgba(205,214,244,1.0)
        set recolor-darkcolor           rgba(30,30,30,1)
        set recolor-lightcolor          rgba(205,214,244,1)
